...
//   useEffect(() => {
//     const displayProduct = productData.find((el) => el._id === filterby);
//     if (displayProduct) {
//       setProductDisplay(displayProduct);
//     } else {
//       // Redirect to a 404 page or a default product page
//       navigate("/404");
//     }
//   }, [filterby, productData, navigate]);
...
//   if (!productDisplay) {
//     // Render loading spinner or message while product is being fetched
