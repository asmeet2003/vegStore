...
//   return (
//     <div className="bg-white shadow-md p-4 rounded-lg min-w-[150px] transition-transform hover:-translate-y-1 hover:shadow-lg">
//       {name ? (
...
//           <button className=' ml-5 bg-red-500 hover:bg-blue-500 py-2 px-4 rounded-md shadow-md transition-colors duration-300 ease-in-out'>
//   Add to Cart
// </button>
//         </Link>
//       ) : (
